...
<form method="POST" enctype="multipart/form-data" class="wcp-form woocommerce">
  ...
  <div class="wcp-form-inner">
    ...
    <?php if( ! isset( $this->options['transfer_date_disabled'] ) ) : ?>
    ...
    <div class="wcp-form-group wcp-col-2">
      ...
      <div class="wcp-form-input">
        <input type="date" class="wcp-form-control" id="wcp-date" name="date" max="<?php echo esc_attr( $current_date ); ?>" value="<?php echo esc_attr( $current_date ); ?>" placeholder="<?php esc_attr_e( 'dd/mm/yyyy', 'woocommerce-confirm-payment' ) ?>">
      </div>
    </div>
    ...
    <div class="wcp-form-group wcp-col-2">
      ...
      <div class="wcp-form-input">
        <input type="time" class="wcp-form-control" id="wcp-time" name="time" placeholder="<?php esc_attr_e( 'hh:mm', 'woocommerce-confirm-payment' ) ?>" value="<?php echo esc_attr( $current_time ); ?>">
      </div>
    </div>
