...
class Woocommerce_Confirm_Payment_Admin_Setting{
  ...
  public function page_init() {
    ...
    add_settings_field(
      'transfer_date_disabled',
      __( 'Transfer date', 'woocommerce-confirm-payment' ),
      array( $this, 'checkbox_callback' ),
      'wcp-setting-admin-general',
      'setting_payment_form',
      array(
        'name'        => 'transfer_date_disabled',
        'description' => __( 'Disable tansfer date', 'woocommerce-confirm-payment' )
      )
    );
